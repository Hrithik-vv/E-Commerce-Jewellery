...
const MOCK_USERS = [
    { id: 1, name: 'Alice Smith', email: 'alice@example.com', role: 'Admin', status: 'Active', joined: '01 Jan 2026', lastLogin: '11 Aug 2026, 10:00 AM' },
    { id: 2, name: 'Bob Jones', email: 'bob@example.com', role: 'Editor', status: 'Inactive', joined: '15 Mar 2026', lastLogin: '10 Aug 2026, 04:30 PM' },
    { id: 3, name: 'Charlie Davis', email: 'charlie@example.com', role: 'Viewer', status: 'Active', joined: '22 May 2026', lastLogin: '09 Aug 2026, 09:15 AM' },
    { id: 4, name: 'Diana Prince', email: 'diana@example.com', role: 'Admin', status: 'Active', joined: '10 Feb 2026', lastLogin: '11 Aug 2026, 11:20 AM' },
    { id: 5, name: 'Evan Wright', email: 'evan@example.com', role: 'Editor', status: 'Active', joined: '05 Apr 2026', lastLogin: '08 Aug 2026, 02:45 PM' }
];
                ...
                <div className="user-list-page-container">
                    ...
                    <div className="user-list-card">
                            ...
                            <table className="user-list-table">
                                ...
                                <tbody>
                                    {filteredUsers.map(user => (
                                        <tr key={user.id}>
                                            <td>
                                                <img src={`https://i.pravatar.cc/150?u=${user.id}`} alt="Avatar" className="user-list-table-avatar" />
                                            </td>
                                            <td>{user.name}</td>
                                            <td>{user.email}</td>
                                            <td>{user.role}</td>
                        ...
                        <div className="user-list-mobile-cards">
                            {filteredUsers.map(user => (
                                <div className="user-list-mobile-card" key={`mobile-${user.id}`}>
                                    ...
                                    <div className="user-list-mobile-card-row">
                                        ...
                                        <span className="user-list-mobile-value">{user.joined}</span>
                                    </div>

                                    <div className="user-list-mobile-card-row">
                                        <span className="user-list-mobile-label">Last Login</span>
                                        <span className="user-list-mobile-value">{user.lastLogin}</span>
                                    </div>
