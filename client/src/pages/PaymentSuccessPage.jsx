      ...
      <div className="psp-popup-container">
        ...
        <div className="psp-icon-container">
          ...
          <svg className="psp-success-icon" width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M26 47.6667C37.9662 47.6667 47.6667 37.9662 47.6667 26C47.6667 14.0338 37.9662 4.33333 26 4.33333C14.0338 4.33333 4.33333 14.0338 4.33333 26C4.33333 37.9662 14.0338 47.6667 26 47.6667Z" stroke="#16A34A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M19.5 26L23.8333 30.3333L32.5 21.6667" stroke="#16A34A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
